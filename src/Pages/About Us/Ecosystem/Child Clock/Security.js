...
const Security = () => {
    return (
        <div className="flex flex-col justify-center w-[40%] mr-auto"
            style={{
        ...
        >
            <div className="flex flex-col justify-evenly">
                <div className="flex flex-col">
                    <ClockTitle className='text-center font-prompt text-xl font-medium w-full mb-3'>Security</ClockTitle>
