...
const Academy = () => {
    return (
        <div className="flex flex-col justify-center w-[30%] ml-auto"
            style={{
        ...
        >
            <div className="flex flex-col justify-evenly">
                <div className="flex flex-col">
                    <ClockTitle className='text-center font-prompt text-xl font-medium w-full mb-3'>Academy</ClockTitle>
