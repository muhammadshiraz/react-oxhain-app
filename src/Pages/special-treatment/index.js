...
const SpecialTreatment = () => {
    return (
        <div className="flex flex-col items-start justify-start w-full special-control-section font-prompt my-20">
            <OxhainBanner  
                className="xsm:mb-5 lg:mb-8 xl:mb-8 2xl:mb-12"
                titleclassname="mt-5"
                breadcrumblink01="/privacy"
                breadcrumb01="Legal"
                breadcrumblink02="/privacy"
                breadcrumb02="Special Treatment"
            ...
            <div className="flex flex-col container mx-auto xsm:px-5 lg:px-2 xl:px-2 2xl:px-2 xsm:mb-5 lg:mb-5 xl:mb-5 2xl:mb-8 text-left">
                ...
                <h4 className="text4 xsm:text-base lg:text-base xl:text-lg 2xl:text-lg font-nomral">Happy Trading on Oxhain</h4>
            </div>
        </div>
    );
};
