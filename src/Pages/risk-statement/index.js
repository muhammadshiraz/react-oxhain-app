...
const RiskStatement = () => {
    return (
        <div className="flex flex-col items-start justify-start w-full risk-control-section font-prompt my-20">
            <OxhainBanner  
                ...
                breadcrumb02="Risk Disclosure Statement"
            ...
            <div className="flex flex-col container mx-auto xsm:px-5 lg:px-2 xl:px-2 2xl:px-2 xsm:mb-5 lg:mb-5 xl:mb-5 2xl:mb-8 text-left">
                ...
                <h4 className="text5 xsm:text-base lg:text-base xl:text-lg 2xl:text-lg font-nomral">The Oxhain Team</h4>
            </div>
        </div>
    );
};
